...
package com.dream.library.widgets.pla;
...
public class PLA_MultiColumnListView extends PLA_ListView {
	...
	public PLA_MultiColumnListView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(AttributeSet attrs) {
		...
		if( attrs == null ){
			...
			TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.PLA_MultiColumnListView);

			int landColNumber = a.getInteger(R.styleable.PLA_MultiColumnListView_plaLandscapeColumnNumber, -1);
			int defColNumber = a.getInteger(R.styleable.PLA_MultiColumnListView_plaColumnNumber, -1);
			...
			mColumnPaddingLeft = a.getDimensionPixelSize(R.styleable.PLA_MultiColumnListView_plaColumnPaddingLeft, 0);
			mColumnPaddingRight = a.getDimensionPixelSize(R.styleable.PLA_MultiColumnListView_plaColumnPaddingRight, 0);
			a.recycle();
		}
