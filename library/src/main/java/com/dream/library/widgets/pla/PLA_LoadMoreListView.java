...
import com.dream.library.progress.CircularProgressBar;
 ...
 * Description:
 */
public class PLA_LoadMoreListView extends PLA_MultiColumnListView implements PLA_AbsListView.OnScrollListener {
    ...
    public PLA_LoadMoreListView(Context context) {
        super(context);
        init(context);
    }

    public PLA_LoadMoreListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PLA_LoadMoreListView(Context context, AttributeSet attrs, int defStyle) {
