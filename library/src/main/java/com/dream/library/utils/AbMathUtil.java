...
public class AbMathUtil {
    ...
    /**
     * 提供精确加法计算的add方法，保留两位小数
     *
     * @param value1 被加数
     * @param value2 加数
     * @return 两个参数的和
     */
    public static double addWithRound(double value1, double value2) {
        return round(add(value1, value2));
    }


    /**
     * 提供精确减法运算的sub方法，保留两位小数
     *
     * @param value1 被减数
     * @param value2 减数
     * @return 两个参数的差
     */
    public static double subWithRound(double value1, double value2) {
        return round(sub(value1, value2));
    }


    /**
     * 提供精确乘法运算的mul方法，保留两位小数
     *
     * @param value1 被乘数
     * @param value2 乘数
     * @return 两个参数的积
     */
    public static double mulWithRound(double value1, double value2) {
        return round(mul(value1, value2));
    }
