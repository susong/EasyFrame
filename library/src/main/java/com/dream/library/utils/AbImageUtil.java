...
public class AbImageUtil {
    ...
    public static TransitionDrawable bitmapToTransitionDrawable(Bitmap bitmap) {
        ...
        try {
            ...
            mBitmapDrawable = new TransitionDrawable(new Drawable[]{
                    new ColorDrawable(BaseLibApplication.getInstance().getResources().getColor(android.R.color.transparent)),
    ...
    public static TransitionDrawable drawableToTransitionDrawable(
        ...
        try {
            ...
            mBitmapDrawable = new TransitionDrawable(new Drawable[]{
                    new ColorDrawable(BaseLibApplication.getInstance().getResources().getColor(android.R.color.transparent)), drawable});
        } catch (Exception e) {
            e.printStackTrace();
        }
        return mBitmapDrawable;
        ...
        if (bitmap != null) {
            try {
                if (!bitmap.isRecycled()) {
                    AbLog.d("Bitmap释放" + bitmap.toString());
                    bitmap.recycle();
                }
            } catch (Exception e) {
            }
