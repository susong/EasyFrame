...
public class AbSmartBarUtils {
   ...
   * AbSmartBarUtils.setActionBarTabsShowAtBottom(bar, true);
   * <p>
   ...
   * AbSmartBarUtils.setActionBarViewCollapsable(bar, true);
   ...
   * AbSmartBarUtils.setActionModeHeaderHidden(bar, true); } }
   */
   ...
   * final ActionBar bar = getActionBar();
   * // 自定义ActionBar的返回键图标
   * AbSmartBarUtils.setBackIcon(bar, getResources().getDrawable(R.drawable.ic_back));
   * ...
   * }
   * }
   * </pre>
   ...
   * @param context
   * @param window
   * @param smartBarHeight set AbSmartBarUtils.SMART_BAR_HEIGHT_PIXEL
   */
