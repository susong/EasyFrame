...
public class AbViewUtil {
     ...
     *
     * @param absListView   the abs mList view
     ...
     * @param lineNumber    每行几个 ListView一行一个item
     * @param verticalSpace the vertical space
     * @return the abs mList view height
     */
    ...
    public static float dp2px(Context context, float dipValue) {
        DisplayMetrics mDisplayMetrics = AbAppUtils.getDisplayMetrics(context);
        return applyDimension(TypedValue.COMPLEX_UNIT_DIP, dipValue, mDisplayMetrics);
    }

    public static int dp2px(int dp) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp,
            BaseLibApplication.getInstance().getResources().getDisplayMetrics());
    }
